...
MACRO(ADD_SWIG_CGAL_LUA_MODULE packagename)
  SET (MODULENAME "CGAL_${packagename}")
  SET (INTERFACE_FILES  "CGAL_${packagename}.i")
  ...
  #Build bindings for LUA
  if(LUA51_FOUND)
    INCLUDE_DIRECTORIES(${LUA_INCLUDE_PATH})
    SET (CMAKE_SWIG_OUTDIR "${LUA_OUTDIR_PREFIX}/CGAL")
    SET(CMAKE_SWIG_FLAGS -lua -DSWIG_CGAL_${packagename}_MODULE)
    SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${LUA_OUTDIR_PREFIX}/CGAL")
    SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY "${LUA_OUTDIR_PREFIX}/CGAL")
    SET(CMAKE_MODULE_OUTPUT_DIRECTORY "${LUA_OUTDIR_PREFIX}/CGAL")
    SWIG_ADD_MODULE(${MODULENAME} LUA ${INTERFACE_FILES} ${object_files})
    SET_TARGET_PROPERTIES(${SWIG_MODULE_${MODULENAME}_REAL_NAME} PROPERTIES PREFIX "")

    SWIG_LINK_LIBRARIES(${MODULENAME} ${libstolinkwith} ${LUA_LIBRARIES})
  endif()
ENDMACRO(ADD_SWIG_CGAL_LUA_MODULE)
